Section written by Kevin Wasiluk for CSE 538 final project.

The main data file is ROCStories.txt and has each story in the ROCStories Corpora seperated by an <|endoftext|> label.

Example text generated by GPT-2 can be found in the files ROCStories_gpt2samples.txt and ROCStories_samples.txt. process_samples.txt can be used to extract individual stories.

The main file for the project is nmt_stories.ipynb, which contains the models and training loop for the project.
It should use Tensorflow 2.0.0.



Code for GPT-2 Files: original README
